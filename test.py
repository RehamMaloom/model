...
async def testing_resumes(testingdata : Request):
    ...
    for user in body["users"]:
        try:
            ...
            print(cvfile)
            with open("6463c0082213e2ac2cf9947b.pdf", 'rb') as file:
                doc.add_paragraph(str(file.read()))
            doc.save("text.docx")
            data = ResumeParser('text.docx').get_extracted_data()
            resume_skills["6463c0082213e2ac2cf9947.pdf"] = data['skills']
            print("hna 3")

        except: 
            data = ResumeParser("6463c0082213e2ac2cf9947b.pdf").get_extracted_data()
            resume_skills["6463c0082213e2ac2cf9947b.pdf"] = data['skills']
    ...
    print(os.getcwd())
    nbrs = joblib.load(r"two_features_model.joblib")
